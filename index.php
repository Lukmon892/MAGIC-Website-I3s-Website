...
<html lang="en">
  ...
  <body>
  <nav class="navbar nav1 navbar-expand-lg bg-light navbar-light margin-top:56px; padding-top: 105px; fixed-top fixed-top-2">
    <div class="container">
  ...
  <nav class="navbar nav2 navbar-expand-lg bg-dark navbar-dark margin-top:56px; padding-top: 105px; fixed-top-2 py-0">
    <div class="container">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
      ...
      <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
        ...
        <header>
          ...
          <!-- <a href="#" class="brand col-md">MAGIC</a>
            <div class="menu-btn"></div> -->

           <!--<a href="#" class="brand">Military Affairs, Government and Intelligence Council</a>
            <div class="menu-btn"></div>
        ...
        <section id="home" class="home">
            ...
            <div class="content">
              <div class="container">
               ...
               <!-- <h1>Overview of<br><span>MAGIC</span></h1> -->
               <p class="lead">The University of North Carolina Wilmington's(UNCW) Millitary Affairs, Government and Intelligence Council(MAGIC) works to advance the   university's sponsored research mission by engaging the MAGIC members' strategic, technical, and cultural expertise.The MAGIC include former and current leaders of federal agencies(e.g., the Department of Defense, Department of State, Department of Energy, e.t.c.), the intelligence community, and other public or private entities. The MAGIC is primarily engaged in providing leadership and expertise in areas related to the millitary, intelligence, and government sectors. A key goal for the MAGIC during the period 2021-2023 is to assist the University to become a national leader in strategic areas involving millitary or intelligence-related research and development.</p>
               <!-- <a href="#">Read More</a>> -->
                  <div class="row text-center g-4">
                    <div class="col-md" id="#mission">
                      <div class="card flex mission bg-dark-card text-light">
                        <img src="img/mission.png" class="card-img-top" alt="">
                        <div class="card-body text-center">
                          <!--<div class="h1 mb-3">
                            <i class="bi bi-laptop"></i>
                          </div>-->
                          <h3 class="card-title mb-3" style="font-family:'Times New Roman', Times, serif"><span class="a_color">Mission of MAGIC</span></h3>
                          <p class="card-text" style="font-family:'Times New Roman', Times, serif">The primary mission of the council is to forge connections and build relationships with local, regional, and national agencies and leaders that will help advance research and academic programming <!-- <span id="text1"> for the university. We are particularly interested in aligning this research work with areas of strategic importance for the university, including artificial intelligence and intelligent systems, cybersecurity, marine science and engineering, and remoote sensing, among others. -->
                          </p>
                    ...
                    <div class="col-md">
                      <div class="card flex bg-dark-card text-light">
                        <img src="img/support.png" class="card-img-top" alt="">
                        <div class="card-body text-center">
                          <!-- <div class="h1 mb-3">
                            <i class="bi bi-people"></i>
                          </div> -->
                          <h3 class="card-title mb-3" style="font-family:'Times New Roman', Times, serif"><span class="a_color">Support UNCW</span></h3>
        ...
        <!--Carousel Images-->
<!-- 
        <section class = "overviews-main py-2">
          <div class="container overview grid">
            <div class="card flex">
            <div class="row align-items-center">
               <div class="col-md p-5">
                   <h1>MAGIC Expectation</h1>
                   <p>
        ...
        <section id="speaker's" class="p-5 bg-light-grey">
          <div class="container speak">
            <div class="row align-items-center">
              <div class="col-md about_overview">
                  <img src="img/united_state_army.jpg" class="img-fluid" alt="" />
                </div>
                
                <div class="col-md p-3 card border-info mb-3" style="max-width: 54rem;">
                <div class="card-header">
                  <h2 style="font-family:'Times New Roman', Times, serif">MAGIC Speaker's Bureau</h2>
                </div>
                <div class="card-body">
                  <p class="card-text" style="font-family:'Times New Roman', Times, serif">
                    The University of North Carolina Wilmington's (UNCW) Military Affairs, Government, and Intelligence Council (MAGIC) works to advance the university's mission by engaging MAGIC members' strategic, technical and cultural expertise. The council works to forge connections and build relationships with local, regional, and national agencies and leaders that will help advance research and academic programing for the university such as Artificial Intelligence, Machine Learning, Deep Learning, Natural Language Processing, Generative Adversarial Networks (GANS), Intelligent Systems, Cybersecurity, Marine Science, Remote Sensing, Organizational Leadership, and Careers in the federal sectors.
                  </p>
      ...
      <section id="i3s" class="p-5 bg-dark-pattern text-light">
        <div class="container highThree">
    ...
    <div id="questions" class="p-5">
      <div class="container">
        ...
        <div class="accordion accordion-flush" id="questions">
                ...
                <ul>
                  ...
                  <div class="row row-cols-1 row-cols-md-2 g-4">
                    <div class="picture col">
                      <div class="card flex">
                        <img src="https://randomuser.me/api/portraits/men/22.jpg" class="card-img-top p-3" alt="...">
                        <!-- <h5 class="card-title text-dark p-3">Card title</h5> -->
                        <div class="card-body text-dark">
                          <h5 class="card-title">James Bishop</h5>
                          <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium suscipit similique beatae esse quisquam nobis necessitatibus neque, veritatis fugiat libero molestiae, sunt dolorem laboriosam accusantium. Quas ipsam eum unde sequi?</p>
                        </div>
                      </div>
                    </div>
                    <div class="picture col">
                      <div class="card flex">
                        <img src="https://randomuser.me/api/portraits/women/22.jpg" class="card-img-top p-3" alt="...">
                        <!-- <h5 class="card-title text-dark">Card title</h5> -->
                        <div class="card-body text-dark">
                          <h5 class="card-title">Sarah Bishop</h5>
                          <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium suscipit similique beatae esse quisquam nobis necessitatibus neque, veritatis fugiat libero molestiae, sunt dolorem laboriosam accusantium. Quas ipsam eum unde sequi?</p>
                        </div>
                      </div>
                    </div>
                    <div class="picture col">
                      <div class="card flex">
                        <img src="https://randomuser.me/api/portraits/men/20.jpg" class="card-img-top p-3" alt="...">
                        <div class="card-body text-dark">
                    ...
                    <div class="picture col">
                      <div class="card flex">
                        <img src="https://randomuser.me/api/portraits/women/29.jpg" class="card-img-top p-3" alt="...">
                        <div class="card-body text-dark">
                          <h5 class="card-title">Cynthia Young</h5>
                          <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium suscipit similique beatae esse quisquam nobis necessitatibus neque, veritatis fugiat libero molestiae, sunt dolorem laboriosam accusantium. Quas ipsam eum unde sequi?</p>
                        </div>
                      </div>
                    </div>
          ...
          <div id="initiatives" class="content p-5">
            <div class="container">
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button
                      ...
                      type="button"
                      data-bs-toggle="collapse"
                      data-bs-target="#initiative-three"
                      style="font-family:'Times New Roman', Times, serif">
                      Event
                    </button>
                  </h2>
  ...
  <div id="people" class="container member p-5">
      ...
      <div class="row g-4">
          ...
          <div class="card bg-light">
            <div class="card-body text-center">
              <img
                ...
                alt=""
              />
              <h3 class="card-title mb-3" style="font-family:'Times New Roman', Times, serif"><span class="a_color">Bill Kawczynski</span></h3>
              <p class="card-text">
                <span class="a_color" style="font-family:'Times New Roman', Times, serif">Director of Military Affairs <br><a class="a_color" href="mailto:kawczynskib@uncw.edu">kawczynskib@uncw.edu</a><br>910-555-555</span> 
              </p>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="card bg-light">
            <div class="card-body text-center">
              <img
                src="img/jess_boersma.jpg"
                class="rounded-circle mb-3"
                alt=""
              />
              <h3 class="card-title mb-3" style="font-family:'Times New Roman', Times, serif"><span class="a_color">Jess Boersma</span></h3>
              <p class="card-text">
                <span class="a_color" style="font-family:'Times New Roman', Times, serif">Associate Director, I3S<br><a class="a_color" href="boersmaj@uncw.edu">boersmaj@uncw.edu</a><br>910-962-3413</span> 
              </p>
              <a href="#"><i class="bi bi-twitter text-dark mx-1"></i></a>
              <a href="#"><i class="bi bi-facebook text-dark mx-1"></i></a>
              <a href="#"><i class="bi bi-linkedin text-dark mx-1"></i></a>
          ...
          <div class="card bg-light">
            <div class="card-body text-center">
              <img
                ...
                alt=""
              />
              <h3 class="card-title mb-3" style="font-family:'Times New Roman', Times, serif"><span class="a_color">Ricanek Karl</span></h3>
              <p class="card-text">
          ...
          <div class="card bg-light">
            <div class="card-body text-center" data-bs-parent="#people">
              <img
                ...
                alt=""
              />
              <h3 class="card-title mb-3" style="font-family:'Times New Roman', Times, serif"><span class="a_color">Vetter Ron</span></h3>
              <p class="card-text" style="font-family:'Times New Roman', Times, serif"><span class="a_color" style="font-family:'Times New Roman', Times, serif">Director of MSCSIS <br><a class="a_color" href="mailto:vetterr@uncw.edu">vetterr@uncw.edu</a><br>910-555-555</span>
         ...
         <section class="container"> 
          <div class="container p-3">
            ...
            <table class="table caption-top table-striped table-responsive">
             <caption class="lead">Contact Us</caption>
              <thead>
                <tr>
              ...
              <tbody>
                <tr>
                  <td>Bill Kawczynski</td>
                  <td>910-555-555</td>
                  <td><a class="a_color" href="mailto:kawczynskib@uncw.edu">kawczynskib@uncw.edu</a></td>
                </tr>
                <tr>
                  <td>Ricanek, Karl</td>
                  <td>910-547-0994</td>
                ...
                <tr>
                  <td>Jess Boersma</td>
                  <td>910-962-3413</td>
                  <td><a class="a_color" href="mailto:boersmaj@uncw.edu">boersmaj@uncw.edu</a></td>
                </tr>
    
                <tr>
                  <td>Vetter, Ron</td>
                  <td>910-555-555</td>
                  <td><a class="a_color" href=mailto:vetterr@uncw.edu>vetterr@uncw.edu</a></td>
                </tr>
              </tbody>
            </table>
            </div>
        ...
        <table class="table table-striped table-responsive">
          ...
          <tbody>
            <tr>
              <td>Bill Kawczynski</td>
              <td>910-555-555</td>
              <td>kawczynskib@uncw.edu</td>
            </tr>
            <tr>
              <td>Ricanek, Karl</td>
              <td>910-555-555</td>
              <td>ricanekk@uncw.edu</td>
            </tr>
            <tr>
              <td>Jess Boersma</td>
              <td>910-962-3413</td>
              <td>boersmaj@uncw.edur</td>
            </tr>

            <tr>
              <td>Vetter, Ron</td>
              <td>910-555-555</td>
              <td>vetterr@uncw.edu</td>
            </tr>
          </tbody>
        </table>
        </div>
    ...
    <!-- <section class=" container p-5">
      <div class="container">
        <div class="row g-4">
          <div class="col-md">
            <h3 class="text-center mb-3" style="font-family:'Times New Roman', Times, serif">Contact Info</h3>
    ...
    <footer class="container p-5 bg-dark text-white text-center position-relative">
      <div class="container">
        <p class="lead" style="font-family:'Times New Roman', Times, serif">Copyright &copy; 2022 MAGIC Website</p>
