              ...
              <div class="col-md-6" id="#mission">
                <div class="card flex mission bg-dark-card text-light">
                  ...
                  <div class="card-body text-center">
                    ...
                    <h3 class="card-title mb-3" style="font-family:'Times New Roman', Times, serif"><span class="a_color">Non Commercial Version</span></h3>
