  ...
  <nav class="navbar navbar-expand-lg bg-dark navbar-dark margin-top:56px; padding-top: 105px; fixed-top-2 py-0">
    <div class="container">
      ...
      <a href="#" class="navbar-brand">
        <span id="pageheader" style="font-size: 130%; text-align:center; font-family:'Times New Roman', Times, serif; justify-content:center; display:flex" class="text-light text-sm-start p-10
